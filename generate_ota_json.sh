...
file_path=$(ls out/target/product/${codename}/lineage-19.1-*-${codename}.zip 2>/dev/null)
filename=$(basename "$file_path")
url="https://github.com/LineageOS-Pixel-Variant/OTA-update/releases/download/s_${codename}_${release_tag}/${filename}"
